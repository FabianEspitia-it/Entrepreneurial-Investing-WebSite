...
export default function NavBar() {
  ...
  return (
    <header
      className={clsx(
        "fixed top-0 left-0 w-full flex justify-between items-center p-4 bg-white z-50 lg:px-24 ",
    ...
    */}
      ...
      <div className="flex gap-4 items-center w-fit">
        <button className="border border-EI_new_green text-EI_new_green p-2 rounded-xl hover:bg-EI_yellow hover:text-white hover:border-EI_yellow duration-200">
          Let&apos;s do it
        </button>
        <MobileMenu />
      </div>
