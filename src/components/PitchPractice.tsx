...
export default function PitchPractice() {
    return (
      <section id='pitch' className="flex flex-col items-center py-24 px-8">
        ...
        <div className="grid grid-cols-2 gap-x-48 gap-y-16 pt-8">
          <div className="flex flex-col items-center justify-center rounded-full shadow-xl p-4 size-48 border-2">
            <Org />
          ...
          <div className="flex flex-col items-center justify-center rounded-full shadow-xl p-4 size-48 border-2">
            <Growth />
            <p className="text-center mt-4 text-gray-700">Sharpen your communication skills and pitch structure.</p>
          </div>
        </div>
        </Fade>
      </section>
