...
function ModuleItem({
  ...
  return (
    <Disclosure>
      {({ open }: { open: boolean }) => (
        <>
          <Disclosure.Button className="font-semibold border-2 w-full text-lg text-left flex gap-2 justify-between items-center w-full py-3 px-4 bg-white hover:bg-gray-100 transition-colors duration-300 rounded-lg shadow-md">
            <div className="flex items-center gap-2">
              <Icon className="size-6 text-EI_new_green" />
...
export default function Modules() {
  return (
    <Fade triggerOnce cascade duration={2000} className="w-full">
      <section id="program" className="w-full px-4 sm:px-6">
        <h2 className="text-3xl lg:text-4xl font-extrabold text-center text-gray-900 pb-10 md:pb-7">
          Program <span className="text-gradient-2">Modules</span>
        </h2>
        <div className="max-w-4xl mx-auto w-full rounded-xl px-6">
