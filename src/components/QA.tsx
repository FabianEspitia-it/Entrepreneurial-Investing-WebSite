    ...
    <Fade triggerOnce duration={2000}>
      ...
      <Fade triggerOnce>        
        <section className='relative pb-12 md:pb-20 px-4 sm:px-6'>
          <p className='text-xl text-black max-w-4xl mx-auto text-center'>Still have more questions? Contact us <a href='mailto:info@fundraisingschool.com' className='text-EI_new_green hover:text-EI_yellow transition-colors'>info@entrepreneurial.com</a> </p>
        </section>
      </Fade>
    </>
  )
